...
```@meta
CurrentModule = DataDecimals
```

## Types

```@docs
DataDecimals.AbstractDecimal
Decimal
DataDecimals.DecimalValue
DataDecimals.Decimal32
DataDecimals.Decimal64
DataDecimals.Decimal128
DataDecimals.Decimal256
```
...
```@docs
DataDecimals.unscaled
DataDecimals.scale
DataDecimals.decimallength
DataDecimals.writedecimal!
```
